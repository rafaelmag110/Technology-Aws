...
class S3DataSource implements DataSource {
    ...
    private List<S3Object> fetchPrefixedS3Objects() {
        ...
        do {
            ...
            s3Objects.addAll(filterFolderFile(response.contents(), objectPrefix));
    ...
    private Collection<S3Object> filterFolderFile(List<S3Object> contents, String objectPrefix) {
